...
function myHttp(val) {
    return (0, rxjs_1.of)(val).pipe((0, rxjs_1.delay)(2000));
}
function asyncVals(val, delay) {
    return (0, rxjs_1.interval)(delay).pipe((0, rxjs_1.map)(function (index) { return val + " " + index; }));
}
...
var ob1$ = asyncVals("OB1 ", 10000);
var ob2$ = asyncVals("OB2 ", 2000);
(0, rxjs_1.forkJoin)([ob1$, ob2$], function (one, two) { return one + ' : ' + two; }).subscribe(function (x) { return console.log(x); });
