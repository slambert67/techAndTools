import { distinctUntilChanged, endWith, map, Observable, of, ReplaySubject, shareReplay, startWith, switchMap, tap } from "rxjs"
...
export class TableRowsModel {
     ...
     */
    private readonly state: Observable<State> = this._projectID.pipe(
