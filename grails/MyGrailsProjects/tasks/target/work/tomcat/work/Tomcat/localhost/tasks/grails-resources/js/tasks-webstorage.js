    ...
    return {
        ...
        initObjectStore: function(type, successCallback, errorCallback) {
            if (!initialized) {
                ...
                localStorage.setItem(type, JSON.stringify({}));  // store new object/table for storing objects of type.
            };
        ...
        save: function(type, obj, successCallback, errorCallback) {
            ...
            if (!obj.id) {
                obj.id = $.now();  // jquery helper function giving current time in milliseconds
            }
        ...
        delete: function(type, id, successCallback, errorCallback) {
            ...
            var storageItem = getStorageObject(type);
            if (storageItem[id]) {
                delete storageItem[id]; // shows deletion of property (and therefore value) from an object
                localStorage.setItem(type,JSON.stringify(storageItem));
                successCallback(id);
            }
            errorCallback("object not found", "The object requested could not be found");
